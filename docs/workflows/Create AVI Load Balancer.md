...
flowchart LR
  ...
  item1["initVariables"]
  item2["mergeServers"]
  item3["determineHealthMonitor"]
  item4["createHealthMonitor"]
  item6["useExistingHealthMonitor?"]
  item7["determinePool"]
  item9["useExistingPool"]
  item10["createPool"]
  item11["determineVIP"]
  item14["createVSVIP"]
  item15["determineVirtualService"]
  item16["createVS"]
  item17["End workflow"]
  item18["item18"]
  item19["Check Health Monitor"]
  item20["clear Health Monitor"]
  item22["Check Pool"]
  item23["Clear Pool"]
